...
feature_catalog = {
    "version": "1.0",
    "description": "Normalized feature catalog used by StaticLab/SusScan phase-3-lite correlation.",
    "features": [
...
references = {
    ...
    "reference_families": {
        ...
        "detection_side_signals": [
            "YARA-Rules",
            "Neo23x0/signature-base",
            "Malpedia",
            "YARA Forge"
        ],
        "standardized_behavior_naming": [
            "MBC",
            "ATT&CK"
        ],
        "apk_heuristics": [
...
manifest = {
    "name": "staticlab-correlation-rule-pack",
    "version": "1.0",
